...
@section('content')
    <div class="box-content">
        <div class="box-heading">
            <div class="box-title">
                <h3 class="mb-35">VOTRE ANNUAIRE EXPERTS</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="" placeholder="Rechercher une region">
                        </div>
                    </div>

                    <div class="col-6">
                        <div class="form-group">
                            <label for="">Domaines d'intervantion</label>
                            <input class="form-control" type="text" name="" placeholder="Domaines">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="">Prix de la postulation maximum</label>
                            <input class="form-control" type="text" name="" placeholder="Prix max">
                        </div>
                    </div>
                ...
                <div class="card-grid-2 hover-up">
                    ...
                    <div class="card-block-info">
                        <div class="row">
                            <div class="col">
                                <div class="mt-5"><span class=""> <i class="fas fa-user bg-primary p-2 color-white" style="border-radius: 100%;"></i>&nbsp; &nbsp;Domaine</span></div>
                                <div class="mt-5"><span class=""> <i class="fas fa-user bg-primary p-2 color-white" style="border-radius: 100%;"></i>&nbsp; &nbsp;Cour d’appel de ressort</span></div>
                                <div class="mt-5"><span class=""> <i class="fas fa-user bg-primary p-2 color-white" style="border-radius: 100%;"></i>&nbsp; &nbsp;Prix de la postulation</span></div>
                            </div>
                            <div class="col">
                                <div  align="right" class="detaill-a-hover mt-100">
