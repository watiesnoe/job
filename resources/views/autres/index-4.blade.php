    ...
    <main class="main">
            ...
            <div class="row">
              ...
              <div class="col-xl-5 col-lg-12 d-none d-xl-block col-md-6">
                <div class="banner-imgs">
                  <div class="block-1 shape-1"><img class="img-responsive" alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/homepage4/banner.png"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            ...
            <div class="box-swiper mt-50 layout-brand-1">
              <div class="swiper-container swiper-group-6 mh-none swiper">
                <div class="swiper-wrapper pb-70 pt-5">
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/homepage4/img-big1.png')"><a href="jobs-grid.html">
                  ...
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/homepage4/img-big2.png')"><a href="jobs-grid.html">
                        <div class="box-cover-img">
                          <div class="content-bottom">
                  ...
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/homepage4/img-big3.png')"><a href="jobs-grid.html">
                        <div class="box-cover-img">
                          <div class="content-bottom">
                  ...
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/homepage4/img-big4.png')"><a href="jobs-grid.html">
                        <div class="box-cover-img">
                          <div class="content-bottom">
                  ...
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/homepage4/img-big5.png')"><a href="jobs-grid.html">
                        <div class="box-cover-img">
                          <div class="content-bottom">
                  ...
                  <div class="swiper-slide hover-up">
                    <div class="card-grid-5 card-category hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/homepage4/img-big6.png')"><a href="jobs-grid.html">
                        <div class="box-cover-img">
                          <div class="content-bottom">
      ...
      <section class="section-box mt-50 mb-20">
        <div class="box-newsletter box-newsletter-2">
          <div class="container">
            <div class="row">
              <div class="col-xl-4 col-12 text-center d-none d-xl-block"><img src="../1.HTML_Template_Frontend/assets/imgs/page/homepage4/img-newsletter.png" alt="joxBox"></div>
