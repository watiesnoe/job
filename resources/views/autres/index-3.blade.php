              ...
              <div class="tab-pane fade show active" id="tab-job-1" role="tabpanel" aria-labelledby="tab-job-1">
                <div class="row">
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        <h6><a href="job-details.blade.php">UX Designer &amp; Researcher remote</a></h6>
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-1.png" alt="jobBox">
                    ...
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-2.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
                    ...
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-3.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
                    ...
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-4.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
                    ...
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-5.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
                    ...
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-6.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
                    ...
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-7.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
                    ...
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-8.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
                    ...
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        ...
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-9.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                      <div class="card-block-info pt-25">
                        <h6><a href="job-details.blade.php">UX Designer &amp; Researcher</a></h6>
                        <div class="mt-5"><span class="card-briefcase mr-15">Remote</span><span class="card-time">3 mins ago</span></div>
                        <div class="mt-20 border-bottom pb-20"><a class="btn btn-grey-small bg-14 mb-5 mr-5" href="jobs-grid.html">Illustrator</a><a class="btn btn-grey-small bg-14 mb-5 mr-5" href="jobs-grid.html">Adobe XD</a><a class="btn btn-grey-small bg-14 mb-5 mr-5" href="jobs-grid.html">Figma</a><a class="btn btn-grey-small bg-14 mb-5 mr-5" href="jobs-grid.html">Sketch</a><a class="btn btn-grey-small bg-14 mb-5 mr-5" href="jobs-grid.html">Lunacy</a>
                        </div>
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-md-7">
                              <div class="d-flex"><img class="img-rounded" src="../1.HTML_Template_Frontend/assets/imgs/brands/brand-10.png" alt="jobBox">
                                <div class="info-right-img">
                                  <h6 class="color-brand-1 lh-14">Linkedin</h6><span class="card-location font-xxs pl-15 color-text-paragraph-2">New York, US</span>
                                </div>
                              </div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="card-grid-2 hover-up">
                  <div class="card-grid-2-image-left">
                    <div class="card-grid-2-image-rd online"><a href="autres/candidate-details.blade.php">
                        <figure><img alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/candidates/user1.png"></figure></a></div>
                    <div class="card-profile pt-10"><a href="autres/candidate-details.blade.php">
                ...
                <div class="box-swiper">
                  <div class="swiper-container swiper-group-7 swiper">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide"><a href="#"><img src="../1.HTML_Template_Frontend/assets/imgs/page/homepage3/microsoft.svg" alt="jobBox"></a></div>
                      <div class="swiper-slide"><a href="#"><img src="../1.HTML_Template_Frontend/assets/imgs/page/homepage3/sony.svg" alt="jobBox"></a></div>
                      <div class="swiper-slide"><a href="#"><img src="../1.HTML_Template_Frontend/assets/imgs/page/homepage3/acer.svg" alt="jobBox"></a></div>
                      <div class="swiper-slide"><a href="#"><img src="../1.HTML_Template_Frontend/assets/imgs/page/homepage3/nokia.svg" alt="jobBox"></a></div>
                      <div class="swiper-slide"><a href="#"><img src="../1.HTML_Template_Frontend/assets/imgs/page/homepage3/asus.svg" alt="jobBox"></a></div>
                      <div class="swiper-slide"><a href="#"><img src="../1.HTML_Template_Frontend/assets/imgs/page/homepage3/casio.svg" alt="jobBox"></a></div>
                      <div class="swiper-slide"><a href="#"><img src="../1.HTML_Template_Frontend/assets/imgs/page/homepage3/dell.svg" alt="jobBox"></a></div>
                    </div>
                  </div>
                </div>
              </div>
