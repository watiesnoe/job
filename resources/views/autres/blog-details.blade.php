  ...
  <body>
    ...
    <main class="main">
      <section class="section-box">
        <div><img src="../1.HTML_Template_Frontend/assets/imgs/page/blog/img-single.png"></div>
      </section>
      <section class="section-box">
            ...
            <div class="box-white">
              <div class="max-width-single"><a class="btn btn-tag" href="#">Job Tips</a>
                ...
                <div class="post-meta text-muted d-flex align-items-center mx-auto justify-content-center">
                  <div class="author d-flex align-items-center mr-30"><img alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/homepage1/user3.png"><span>Sarah Harding</span></div>
                  <div class="date"><span class="font-xs color-text-paragraph-2 mr-20 d-inline-block"><img class="img-middle mr-5" src="../1.HTML_Template_Frontend/assets/imgs/page/blog/calendar.svg"> 06 Sep 2022</span><span class="font-xs color-text-paragraph-2 d-inline-block"><img class="img-middle mr-5" src="../1.HTML_Template_Frontend/assets/imgs/template/icons/time.svg"> 8 mins to read</span></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-10 mx-auto">
              <div class="single-body">
                ...
                <figure><img src="../1.HTML_Template_Frontend/assets/imgs/page/blog/img-content.png"></figure>
                <div class="max-width-single">
                  ...
                  <div class="single-apply-jobs mt-20">
                    <div class="row">
                      ...
                      <div class="col-md-5 text-lg-end social-share">
                        <h6 class="color-text-paragraph-2 d-inline-block d-baseline mr-20 mt-10">Share</h6><a class="mr-20 d-inline-block d-middle hover-up" href="#"><img alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/blog/fb.svg"></a><a class="mr-20 d-inline-block d-middle hover-up" href="#"><img alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/blog/tw.svg"></a><a class="mr-0 d-inline-block d-middle hover-up" href="#"><img alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/blog/pi.svg"></a>
                      </div>
                    </div>
                  </div>
                  <h3>Comments</h3>
                  <ul class="list-comments">
                    <li>
                      <div class="author-bio mt-40 bg-white">
                        <div class="author-image mb-15"><a href="author.html"><img class="avatar" src="../1.HTML_Template_Frontend/assets/imgs/page/candidates/user5.png" alt=""></a>
                    ...
                    <li>
                      <div class="author-bio mt-40 bg-white">
                        <div class="author-image mb-15"><a href="author.html"><img class="avatar" src="../1.HTML_Template_Frontend/assets/imgs/page/candidates/user1.png" alt=""></a>
                          <div class="author-infor">
                      ...
                      <ul>
                        <li>
                          <div class="author-bio mt-40 bg-white">
                            <div class="author-image mb-15"><a href="author.html"><img class="avatar" src="../1.HTML_Template_Frontend/assets/imgs/page/candidates/user3.png" alt=""></a>
                              <div class="author-infor">
