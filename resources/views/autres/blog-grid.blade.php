          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
              <div class="card-grid-5">
                <div class="card-grid-5 hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/blog/img-big1.png')"><a href="blog-details.blade.php">
                    <div class="box-cover-img">
                      <div class="content-bottom">
                        <h3 class="color-white mb-20">11 Tips to Help You Get New Clients</h3>
                        <div class="author d-flex align-items-center mr-20"><img class="mr-10" alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/candidates/user3.png"><span class="color-white font-sm mr-25">Azumi Rose</span><span class="color-white font-sm">25 April 2022</span></div>
                      </div>
                    </div></a></div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
              <div class="card-grid-5 hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/blog/img-big2.png')"><a href="blog-details.blade.php">
                  <div class="box-cover-img">
                    <div class="content-bottom">
                      <h3 class="color-white mb-20">Recruiter and Land Your Dream Job</h3>
                      <div class="author d-flex align-items-center mr-20"><img class="mr-10" alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/candidates/user1.png"><span class="color-white font-sm mr-25">Thompson</span><span class="color-white font-sm">28 April 2022</span></div>
                    </div>
                  </div></a></div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
              <div class="card-grid-5 hover-up" style="background-image: url('../1.HTML_Template_Frontend/assets/imgs/page/blog/img-big3.png')"><a href="blog-details.blade.php">
                  <div class="box-cover-img">
                    <div class="content-bottom">
                      <h3 class="color-white mb-20">Work-From-Home Jobs That Pay Well</h3>
                      <div class="author d-flex align-items-center mr-20"><img class="mr-10" alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/blog/ava_1.png"><span class="color-white font-sm mr-25">Alice Json</span><span class="color-white font-sm">29 April 2022</span></div>
                    </div>
                  </div></a></div>
            </div>
          </div>
              ...
              <div class="col-lg-8">
                <div class="row">
                  <div class="col-lg-6 mb-30">
                    <div class="card-grid-3 hover-up">
                      <div class="text-center card-grid-3-image"><a href="blog-details.blade.php">
                          <figure><img alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/blog/img1.png"></figure></a></div>
                  ...
                  <div class="col-lg-6 mb-30">
                    <div class="card-grid-3 hover-up">
                      <div class="text-center card-grid-3-image"><a href="blog-details.blade.php">
                          <figure><img alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/blog/img2.png"></figure></a></div>
                      <div class="card-block-info">
                  ...
                  <div class="col-lg-6 mb-30">
                    <div class="card-grid-3 hover-up">
                      <div class="text-center card-grid-3-image"><a href="blog-details.blade.php">
                          <figure><img alt="jobBox" src="../1.HTML_Template_Frontend/assets/imgs/page/blog/img3.png"></figure></a></div>
                      <div class="card-block-info">
                        <div class="tags mb-15"><a class="btn btn-tag" href="blog-grid.blade.php">Events</a></div>
